...
//   const [users, setUsers] = useState([]); // Users you follow
//   const [followingIds, setFollowingIds] = useState([]); // IDs of users you follow
//   const [firestoreFollowingCount, setFirestoreFollowingCount] = useState(0); // Count from Firestore
...
//       if (isFollowing) {
//         // Unfollow: remove from Firestore and decrement counts
...
//       } else {
//         // Follow: add to Firestore and increment counts
...
//       <h2 className="text-lg font-semibold px-6 pt-6 pb-2">
//         Following {`(${firestoreFollowingCount})`}
//       </h2>
//       {users.length === 0 ? (
...
//                 </div>
//                 <button
//                   className={`ml-4 px-4 py-1 rounded-full border font-semibold transition
//                     ${updating[user.id]
...
//                 </button>
//                 <span className="ml-2 text-2xl text-gray-400 cursor-pointer">⋯</span>
//               </li>
//             );
//           })}
//         </ul>
          ...
          {filteredUsers.map((user) => {
            ...
            return (
              ...
              >
                ...
                <button
                  className={`ml-4 px-5 py-2 rounded-full border font-semibold transition
                    ${updating[user.id]
                      ? "bg-gray-200 text-gray-400 border-gray-200 cursor-not-allowed"
                      : isFollowing
                        ? "bg-white text-gray-900 border-gray-300 hover:bg-gray-100"
